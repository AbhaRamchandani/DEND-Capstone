...
# udf to return state codes
state_udf = udf(lambda x: us_state_codes[x], StringType())
...
state_abrvtn_udf = udf(lambda x: state_abrvtn[x], StringType())
...
# Immigration codes taken from I94_SAS_Lables_Description.SAS
immigration_codes = {
...
# udf to return the country of origin
origin_country_udf = udf(lambda x: immigration_codes[x], StringType())